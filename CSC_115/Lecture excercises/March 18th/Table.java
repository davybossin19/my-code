public class Table extends Furniture {
  ...
  public Table(String name, String itemID, String material, double price, double length, double width) {
    super(name, itemID, material, price);
    this.tableShape = new Rectangle(length, width);
  }
