...
public class Lab6TesterPart1 {
    ...
    public static void testStackUseFunctions() {
        ...
        resultString = reverseString("a");
        expected = "a";
        displayResults(resultString.equals(expected), "reverse \"a\"");

        resultString = reverseString("abc");
        expected = "cba";
        displayResults(resultString.equals(expected), "reverse \"abc\"");

        resultString = reverseString("123");
        expected = "321";
        displayResults(resultString.equals(expected), "reverse \"123\"");

		// Add more tests for reverseString here


        System.out.println("Bracket Math tests ------------------------------");
        boolean matched;
        ...
        matched = doBracketsMatch("k(lmnab");
        displayResults(!matched, "doBracketsMatch \"k(lmnab\"");
		...
		// Add more tests for doBracketsMatch here
    }
    ...
    public static String reverseString(String str) {
        ...
        Stack strStack = new StackArrayBased();
    ...
    public static boolean doBracketsMatch(String str) {
        ...
        Stack openBracks = new StackArrayBased();
        int strLength = str.length();

        for (int i = 0; i < strLength; i++) {
          if (str.charAt(i) == '(') {
            openBracks.push('(');
          } else if (str.charAt(i) == ')' && !openBracks.isEmpty()) {
            openBracks.pop();
          } else if (str.charAt(i) == ')' && openBracks.isEmpty()) {
            return false;
          }
