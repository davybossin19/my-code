...
public class Lab2 {
    ...
    Student higherGradeStudent;

    if (s1.getGrade() >= s2.getGrade()) {
      higherGradeStudent = s1;
    } else {
      higherGradeStudent = s2;
    }

		return higherGradeStudent; // so it compiles
	}
