...
public class A6Tester {
	...
	public static void main (String[] args) {
		...
		System.out.println("\nTesting " + (testHeapSolution ? "Heap" : "Linked" ) + " implementation.");
		...
		System.out.println("\n\nTesting Emergency Room Application using Priority Queue.");
		testPatient();
		testEmergencyRoom();
	...
	public static void testInsertionAndRemoval() {
		...
		pq.insert(10);
		// System.out.println("Result after inserting 8" + pq);
		pq.insert(9);
		// System.out.println("Result after inserting 9" + pq);
		pq.insert(8);
		// System.out.println("Result after inserting 10" + pq);
	...
	public static void testGeneric() {
		...
		pq.insert("abc");
		// System.out.println("Result after inserting \"abc\": " + pq);
		pq.insert("def");
		// System.out.println("Result after inserting \"def\": " + pq);
		pq.insert("ghi");
		// System.out.println("Result after inserting \"ghi\": " + pq);
		// System.out.println();

		// System.out.println(pq.getElement(0));
		// System.out.println(pq.getElement(1));
		// System.out.println(pq.getElement(2));

		// System.out.println("pq size(): " + pq.size());


		result = ((String)pq.removeMin());
		// System.out.println("pq after removeMin: " + pq + ", Result: " + result);
...
public static void testPatient() {
		System.out.println("\nTesting Patient creation, compareTo and equals.");
		...
		displayResults(p2.compareTo(p4) > 0, "testing Patient compareTo");
		displayResults(p3.equals(p4), "testing Patient equals");

	}

	public static void testEmergencyRoom() {
		System.out.println("\nTesting adding/removing patients from an emergency room.");
