...
public class A1Tester {
    ...
    int expected = 0;
		...
		System.out.println("\nTesting greatestCommonDenominator(2, 4)");
		result = A1Exercises.greatestCommonDenominator(2, 4);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(6, 8)");
		result = A1Exercises.greatestCommonDenominator(6, 8);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(48, 84)");
		result = A1Exercises.greatestCommonDenominator(48, 84);
		expected = 12;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(15, 20)");
		result = A1Exercises.greatestCommonDenominator(15, 20);
		expected = 5;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(27, 18)");
		result = A1Exercises.greatestCommonDenominator(27, 18);
		expected = 9;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(21334, 314320)");
		result = A1Exercises.greatestCommonDenominator(21334, 314320);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	...
	public static void testSumArray() {
		...
		System.out.println("\nTesting sumArray with an empty array");
	...
	public static void testContains() {
		...
		System.out.println("\nTesting contains with an empty array");
    ...
    System.out.println("\nTesting countMatches(arr1, 2)");
		result = A1Exercises.countMatches(arr1, 2);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

    System.out.println("\nTesting countMatches(arr1, 3)");
		result = A1Exercises.countMatches(arr1, 3);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

    System.out.println("\nTesting countMatches(arr2, 2)");
